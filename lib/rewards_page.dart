...
class RewardsPageState extends State<RewardsPage> {
  ...
  Future<void> fetchRewards() async {
      try {
          final response =
              await http.get(Uri.parse('http://192.168.1.109:3000/rewards'));
  ...
  Future<void> fetchRedeemedRewards() async {
    try {
      final response = await http.get(
        Uri.parse(
            'http://192.168.1.109:3000/redeemed/${widget.customer['customer_id']}'),
      );
  ...
  Future<void> fetchCustomerData() async {
    try {
      final response = await http.get(
        Uri.parse(
            'http://192.168.1.109:3000/customer/${widget.customer['customer_id']}'),
      );
  ...
  Future<void> redeemReward(int rewardId, int pointsUsed, int redeemQuantity) async {
      ...
      try {
          final response = await http.post(
              Uri.parse('http://192.168.1.109:3000/api/redeem'),
