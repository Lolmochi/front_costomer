...
class _ChangePasswordPageState extends State<ChangePasswordPage> {
  ...
  Future<void> _changePassword() async {
    ...
    final url = Uri.parse('http://192.168.1.109:3000/change_password'); // แทนที่ด้วย URL ของคุณ
...
class _DividendsPageState extends State<DividendsPage> {
  ...
  Future<void> fetchYears() async {
    final url = Uri.parse('http://192.168.1.109:3000/annual_dividends/years'); // Replace with your server URL
  ...
  Future<void> fetchDividendsData(String year) async {
      final url = Uri.parse('http://192.168.1.109:3000/annual_dividends?year=$year'); // Make sure the query string is correct
